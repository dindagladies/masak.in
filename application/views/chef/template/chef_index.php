...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/dropify.css') ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/trumbowyg.min.css') ?>">
  <!-- endinject -->
...
<?php $this->load->view('chef/template/chef_navbar') ?>
<div class="container-fluid page-body-wrapper">
      <div class="main-panel">
          <div id="konten">
          <?= $contents ?>
          </div>
          <?php $this->load->view('chef/template/chef_footer') ?>
      </div>
</div>
