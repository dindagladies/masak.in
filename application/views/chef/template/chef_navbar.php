  ...
  <nav class="bottom-navbar">
    <div class="container">
      <ul class="nav page-navigation" style="justify-content: left;">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('chef/') ?>">
            <i class="mdi mdi-view-dashboard-outline menu-icon"></i>
            <span class="menu-title">Dashboard</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('chef/report') ?>">
          ...
          <div class="submenu">
            <div class="col-group-wrapper row">
              <div class="col-group col-md-3">
                <p class="category-heading">Halaman Profil</p>
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('chef/profil') ?>')">Profil saya</a></li>
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('chef/gallery') ?>')" >Galery Saya</a></li>
                </ul>
              </div>
              <div class="col-group col-md-3">
                <p class="category-heading">Food Pages</p>
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('makanan/') ?>')" >Tabel Makanan</a></li>
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('makanan/insert') ?>')" >insert Makanan</a></li>
                </ul>
              </div>
              <div class="col-group col-md-3">
                <p class="category-heading">Order Pages</p>
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('order/') ?>')">Tabel Order</a></li>
                  <li class="nav-item"><a class="nav-link" href="#" onclick="loadMenu('<?php echo base_url('order/timeline') ?>')">Timeline</a></li>
                </ul>
              </div>
              <div class="col-group col-md-3">
